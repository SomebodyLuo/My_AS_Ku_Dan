...
abstract class AbstractUVCCameraHandler extends Handler {
    ...
    private static final int MSG_GET_FRAME_INFO = 10;
    ...
    public void startGetFrameInfo() {
        checkReleased();
        sendEmptyMessage(MSG_GET_FRAME_INFO);
    }
    ...
    public void handleMessage(final Message msg) {
        ...
        switch (msg.what) {
            ...
            case MSG_RELEASE:
                ...
                break;
            case MSG_GET_FRAME_INFO:
                thread.handleGetFrameInfo();
                break;
            default:
    ...
    static final class CameraThread extends Thread {
        ...
        public void handleCaptureStill(final String path) {
            ...
            try {
                // luoyouren-20180201: capture frame
                final Bitmap bitmap = mWeakCameraView.get().captureStillImage();
                Log.e("luoyouren2", "bitmap.w = " + bitmap.getWidth() + "; .h = " + bitmap.getHeight());
        ...
        public void handleStartRecording() {
            ...
            try {
                ...
                if (videoEncoder != null) {
                    // luoyouren-20180131: 15. user set callback
        ...
        public void handleGetFrameInfo() {
            if (true) Log.v(TAG_THREAD, "handleGetFrameInfo:");

            // frame size
            // 640 x 480 = 307200
            // PIXEL_FORMAT_RAW: 614400 = 640 x 480 x 2
            // PIXEL_FORMAT_RGB565: 614400 = 640 x 480 x 2
            // PIXEL_FORMAT_YUV: 614400 = 640 x 480 x 2
            // PIXEL_FORMAT_YUV420SP: 460800  = 640 x 480 x 3 / 2
            // PIXEL_FORMAT_NV21: 460800  = 640 x 480 x 3 / 2
            // PIXEL_FORMAT_RGBX: 1228800 = 640 x 480 x 4
            mUVCCamera.setFrameCallback(mIFrameInfoCallback, UVCCamera.PIXEL_FORMAT_RAW);
        }
        ...
        volatile private int mFrameCounts = 0;

        private final IFrameCallback mIFrameInfoCallback = new IFrameCallback() {
            @Override
            public void onFrame(final ByteBuffer frame) {
                mFrameCounts++;
                if ((mFrameCounts % 100) == 1) {

                    Log.e("luoyouren3", "mFrameCounts = " + mFrameCounts + "; frame.size = " + frame.capacity());
                    if (false)
                    {

                        // luoyouren-20180202: save bitmap ok!!!
                        Bitmap bitmap = Bitmap.createBitmap(640, 480, Bitmap.Config.ARGB_8888);
                        bitmap.copyPixelsFromBuffer(frame);

//                    final Bitmap bitmap = BitmapFactory.decodeByteArray(frame.array(), 0, frame.capacity());
                        if (null == bitmap) {
                            Log.e("luoyouren2", "BitmapFactory.decodeByteArray failed!");
                        } else {
                            try {
                                String path = "";
                                Log.e("luoyouren2", "bitmap.w = " + bitmap.getWidth() + "; .h = " + bitmap.getHeight());
        ...
        public void handleUpdateMedia(final String path) {
            ...
            if (parent != null && parent.getApplicationContext() != null) {
                try {
                    ...
                    Log.e("luoyouren2", "bitmap save path: " + path);
